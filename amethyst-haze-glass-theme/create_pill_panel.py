...
<svg width="60" height="52" version="1.1" xmlns="http://www.w3.org/2000/svg">
  ...
  <g id="topleft">
    ...
    <path fill="#0e0a10" fill-opacity="0.5" d="M 26,0 A 26,22 0 0,0 0,22 L 26,22 Z"/>
  </g>
  <g id="top">
    <rect x="26" y="0" width="8" height="22" fill="none"/>
    <rect fill="#0e0a10" fill-opacity="0.5" x="26" y="0" width="8" height="22"/>
  </g>
  <g id="topright">
    <rect x="34" y="0" width="26" height="22" fill="none"/>
    <path fill="#0e0a10" fill-opacity="0.5" d="M 34,0 A 26,22 0 0,1 60,22 L 34,22 Z"/>
  </g>

  <g id="left">
    <rect x="0" y="22" width="26" height="8" fill="none"/>
    <rect fill="#0e0a10" fill-opacity="0.5" x="0" y="22" width="26" height="8"/>
  </g>
  <g id="center">
    <rect x="26" y="22" width="8" height="8" fill="none"/>
    <rect fill="#0e0a10" fill-opacity="0.5" x="26" y="22" width="8" height="8"/>
  </g>
  <g id="right">
    <rect x="34" y="22" width="26" height="8" fill="none"/>
    <rect fill="#0e0a10" fill-opacity="0.5" x="34" y="22" width="26" height="8"/>
  </g>

  <g id="bottomleft">
    <rect x="0" y="30" width="26" height="22" fill="none"/>
    <path fill="#0e0a10" fill-opacity="0.5" d="M 0,30 A 26,22 0 0,0 26,52 L 26,30 Z"/>
  </g>
  <g id="bottom">
    <rect x="26" y="30" width="8" height="22" fill="none"/>
    <rect fill="#0e0a10" fill-opacity="0.5" x="26" y="30" width="8" height="22"/>
  </g>
  <g id="bottomright">
    <rect x="34" y="30" width="26" height="22" fill="none"/>
    <path fill="#0e0a10" fill-opacity="0.5" d="M 60,30 A 26,22 0 0,1 34,52 L 34,30 Z"/>
  </g>
